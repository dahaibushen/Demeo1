...
- (nullable NSString *)cachePathForKey:(nullable NSString *)key inPath:(nonnull NSString *)path {
    //备注filename:5301bb58f27323bb0e3f9a64a872dd26.jpg本地保存图片名称   key:http://img.zcool.cn/community/0142135541fe180000019ae9b8cf86.jpg 链接名称
...
- (nullable NSString *)makeDiskCachePath:(nonnull NSString*)fullNamespace {
    ...
    //备注检测本地地址
    NSLog(@"look here check address -----: %@",[paths[0] stringByAppendingPathComponent:fullNamespace]);
